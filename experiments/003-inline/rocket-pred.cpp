...
int main(int argc, char *argv[]) {
  ...
  error_file.realize(cxsom::type::make("Scalar"), 2, 100000, true);
  cxsom::data::File speed_file(std::filesystem::path("root-dir"), speed_var);
  speed_file.realize(cxsom::type::make("Scalar"), 2, 100000, true);
  cxsom::data::File thrust_file(std::filesystem::path("root-dir"), thrust_var);
  thrust_file.realize(cxsom::type::make("Scalar"), 2, 100000, true);
