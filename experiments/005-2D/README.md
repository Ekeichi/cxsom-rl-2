...
### Visualiser les poids pendant ou après l'entraînement
Affiche la surface 2D de la carte choisie dans l'espace (error, speed, thrust).
```
make show-surface TARGET_MAP=error
make show-surface TARGET_MAP=speed
make show-surface TARGET_MAP=thrust
```
